...
\draw[->, shorten >= 10pt] node[draw=none, left = 1cm of root,yshift=12pt]{$first_0$} edge (root);
\draw[->, shorten >= 10pt] node[draw=none, right = 1cm of root,yshift=12pt]{$last_0$} edge (root);

\draw[->, shorten >= 10pt] node[draw=none, left = 1cm of v3,yshift=12pt]{$first_1$} edge (v3);
\draw[->, shorten >= 10pt] node[draw=none, right = 1cm of v3,yshift=12pt]{$last_1$} edge (v3);

\draw[->, shorten >= 10pt] node[draw=none, left = 1cm of v3]{$first_2$} edge (v3);
\draw[->, shorten >= 10pt] node[draw=none, right = 1cm of v4,yshift=12pt]{$last_2$} edge (v4);

\draw[->, shorten >= 10pt] node[draw=none, left = 1cm of v2,yshift=12pt]{$first_3$} edge (v2);
\draw[->, shorten >= 10pt] node[draw=none, right = 1cm of v4]{$last_3$} edge (v4);

\draw[->, shorten >= 10pt] node[draw=none, left = 1cm of v1]{$first_4$} edge (v1);
\draw[->, shorten >= 10pt] node[draw=none, right = 1cm of v4,yshift=-12pt]{$last_4$} edge (v4);

\draw[->, shorten >= 10pt] node[draw=none, left = 1cm of v2]{$first_5$} edge (v2);
\draw[->, shorten >= 10pt] node[draw=none, right = 1cm of v3]{$last_5$} edge (v3);

\draw[->, shorten >= 10pt] node[draw=none, left = 1cm of v2,yshift=-12pt]{$first_6$} edge (v2);
\draw[->, shorten >= 10pt] node[draw=none, right = 1cm of v2,yshift=12pt]{$last_6$} edge (v2);

\draw[->, shorten >= 10pt] node[draw=none, left = 1cm of v9]{$first_7$} edge (v9);
\draw[->, shorten >= 10pt] node[draw=none, right = 1cm of v2]{$last_7$} edge (v2);

\draw[->, shorten >= 10pt] node[draw=none, left = 1cm of root]{$first_8$} edge (root);
\draw[->, shorten >= 10pt] node[draw=none, right = 1cm of root]{$last_8$} edge (root);

\draw[->, shorten >= 10pt] node[draw=none, left = 1cm of v6]{$first_9$} edge (v6);
\draw[->, shorten >= 10pt] node[draw=none, right = 1cm of v6]{$last_9$} edge (v6);
...
\Function{k-th}{$d, k$}
    \State $mid = \Call{LCA}{d.\V{first}, d.\V{last}}$
