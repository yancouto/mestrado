...
\Tree [.\node[b]{7}; [.\node[b]{5}; [.\node[r]{1}; \edge[ed];\node[n]{}; \edge[ed];\node[n]{}; ] \edge[ed];[.\node[n]{}; ] ] [.\node[b]{10}; [.\node[r]{8}; \edge[ed];\node[n]{}; \edge[ed];\node[n]{}; ] \edge[ed];[.\node[n]{}; ] ] ]
\end{tikzpicture}
\caption{Exemplo de árvore rubro-negra. Como no resto das figuras do capítulo, os nós negros têm fundo cinza e os nós vermelhos têm fundo branco. Nas próximas figuras, o valor armazenado em cada nó não é especificado.} \label{fig:arv_bin_ex}
\end{figure}
...
\item Nenhuma propriedades é violada por outros nós.
\end{enumerate}
...
A primeira coluna da Tabela~\ref{tab:arb_comp} mostra o consumo de tempo e espaço da implementação apresentada neste capítulo.
