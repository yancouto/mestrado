...
Lembre-se que~$p$ é o nó de uma arborescência, então~\func{k-th}{p, k} precisa determinar o~$k$-ésimo ancestral de~$p$, ou seja, o vértice alcançado a partir de~$p$ ao caminhar por~$k$ links~$\V{next}$. \\
