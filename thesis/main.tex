...
A DS is~\deff{partially persistent} if it allows access operatiors to previous versions of the structure and update operations only in the newest version, and~\deff{totally persistent} if it also allows update operations on all versions.
